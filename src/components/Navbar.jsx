...
const Navbar = () => {
    ...
    return (
        <div className="sticky top-0 bg-[#65c0b1] flex items-center justify-between px-12 py-6">
            ...
            <div className="hidden md:block">
                <ul className="flex space-x-8 text-gray-800">
                    <li className="transition-all ease-in-out hover:text-black">
                        <a href="/">Home</a>
                    </li>
                    <li className="transition-all ease-in-out hover:text-black">
                        <a href="/">About</a>
            ...
            <div
                ...
                } absolute w-full top-20 left-0 right-0 text-center bg-[#65c0b1] py-8`}
            >
